package com.ble1st.connectias.feature.security.privacy.ui
...
private fun PrivacyDashboardContent(
    ...
    LazyColumn(
        ...
        item {
            Text(
                text = getThemedString(stringResource(R.string.privacy_dashboard_title)),
        ...
        item {
            Button(onClick = onRefresh, modifier = Modifier.fillMaxWidth()) {
                Text(getThemedString(stringResource(R.string.refresh_privacy_status)))
            }
        }
...
private fun OverallStatusCard(status: PrivacyStatus) {
    ...
    Card(
        ...
        Row(
            ...
            Column {
                Text(getThemedString(stringResource(R.string.overall_status)), style = MaterialTheme.typography.labelLarge)
...
private fun PrivacyDetailsSection(uiState: UiState) {
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
            Text(getThemedString(stringResource(R.string.privacy_overview)), style = MaterialTheme.typography.titleMedium)
