...
private fun PermissionsAnalyzerContent(
    ...
    LazyColumn(
        ...
        item {
            Text(
                text = getThemedString(stringResource(R.string.permissions_analyzer_title)),
            ...
            Button(
                ...
                Text(getThemedString(stringResource(R.string.analyze_permissions)))
            }
        }
        ...
        when (state) {
                ...
                item {
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(getThemedString(stringResource(R.string.total_apps_scanned, state.allApps.size)))
                            Text(getThemedString(stringResource(R.string.apps_with_risky_permissions, state.riskyApps.size)))
                        }
                    }
                }
                 ...
                 item {
                    Card(
                        ...
                        modifier = Modifier.fillMaxWidth()
                         ...
                         Column(modifier = Modifier.padding(16.dp)) {
                            Text(
                                getThemedString(stringResource(R.string.recommendations)),
                                style = MaterialTheme.typography.titleMedium
                            )
                            Spacer(modifier = Modifier.height(8.dp))
                    ...
                    Button(
                        ...
                        Text(getThemedString(stringResource(R.string.back_to_list)))
                    }
                 }
            }
            is PermissionsState.Idle -> {
                 item {
                     Text(
                        text = getThemedString(stringResource(R.string.tap_analyze_permissions)),
    ...
    Card(
        ...
        Row(
            ...
            Column {
                ...
                Text(
                    getThemedString(stringResource(R.string.risky, app.riskyPermissions.joinToString(", "))),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.error
                )
            }
