#!/bin/bash
# Build script for Rust secure notes encryption library
...
echo "Building Rust secure notes encryption for Android..."
...
for ABI in "${ABIS[@]}"; do
    ...
    if [ -f "${TARGET_DIR}/libconnectias_secure_notes.so" ]; then
