...
fun DashboardScreen(
    ...
    onNavigateToSecurityDashboard: (() -> Unit)? = null,
    onNavigateToPrivacyDashboard: (() -> Unit)? = null,
    onNavigateToAnalyticsDashboard: (() -> Unit)? = null,
    ...
    Scaffold(
        ...
        floatingActionButton = {
            val hasAdminNav = onNavigateToSecurityDashboard != null ||
                onNavigateToPrivacyDashboard != null ||
                onNavigateToAnalyticsDashboard != null
            if (hasAdminNav) {
                androidx.compose.foundation.layout.Box {
                    FloatingActionButton(onClick = { showAdminMenu = true }) {
                    ...
                    DropdownMenu(
                        ...
                        if (onNavigateToSecurityDashboard != null) {
                            DropdownMenuItem(
                        ...
                        if (onNavigateToPrivacyDashboard != null) {
                            DropdownMenuItem(
                        ...
                        if (onNavigateToAnalyticsDashboard != null) {
                            DropdownMenuItem(
