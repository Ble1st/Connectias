...
object StringMappings {
    ...
    /**
     * Checks if a mapping exists for the given string.
     */
    fun hasMapping(standard: String): Boolean {
        return mappings.containsKey(standard)
    }
    
    /**
     * Gets all available mappings (for testing/debugging).
     */
