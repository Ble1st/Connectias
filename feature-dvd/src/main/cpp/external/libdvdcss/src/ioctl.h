...
/* Legacy FD-based ioctl functions (for direct device access) */
...
int ioctl_ReadCPRMMKBPack   ( int, const int*, int, uint8_t *, int * );
int ioctl_ReadCPRMMediaId   ( int, const int *, uint8_t * );

/* 
 * dvdcss-aware ioctl functions that support stream callbacks.
 * These functions check if a stream callback with pf_ioctl is available
 * and use it, otherwise fall back to direct ioctl calls.
 */
int css_ReadCopyright     ( dvdcss_t, int, int * );
int css_ReadDiscKey       ( dvdcss_t, const int *, uint8_t * );
int css_ReadTitleKey      ( dvdcss_t, const int *, int, uint8_t * );
int css_ReportAgid        ( dvdcss_t, int * );
int css_ReportChallenge   ( dvdcss_t, const int *, uint8_t * );
int css_ReportKey1        ( dvdcss_t, const int *, uint8_t * );
int css_ReportASF         ( dvdcss_t, int * );
int css_InvalidateAgid    ( dvdcss_t, int * );
int css_SendChallenge     ( dvdcss_t, const int *, const uint8_t * );
int css_SendKey2          ( dvdcss_t, const int *, const uint8_t * );
int css_ReportRPC         ( dvdcss_t, int *, int *, int * );
