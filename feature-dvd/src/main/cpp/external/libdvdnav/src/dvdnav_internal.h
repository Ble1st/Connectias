...
typedef enum {
    /* set during the last 3 VOBU preceding an interleaved block. */
  DSI_ILVU_BLOCK = 1 << 14 /* set for all VOBU in an interleaved block */
    , /* set for the first VOBU for a given angle or scene within a ILVU, or the first VOBU in the preparation (PREU) sequence */
