 ...
 */
DVDNAV_API dvdnav_status_t dvdnav_close(dvdnav_t *this);

/*
 * Resets the DVD virtual machine and cache buffers.
 */
DVDNAV_API dvdnav_status_t dvdnav_reset(dvdnav_t *this);
 ...
 */
DVDNAV_API const char* dvdnav_err_to_string(dvdnav_t *this);
 ...
 */
DVDNAV_API dvdnav_status_t dvdnav_get_next_block(dvdnav_t *this, uint8_t *buf,
 ...
 */
DVDNAV_API dvdnav_status_t dvdnav_get_next_cache_block(dvdnav_t *this, uint8_t **buf,
                                            int32_t *event, int32_t *len);
 ...
 *
 */
DVDNAV_API dvdnav_status_t dvdnav_get_disk_region_mask(dvdnav_t *this, int32_t *region_mask);
 ...
 */
DVDNAV_API pci_t* dvdnav_get_current_nav_pci(dvdnav_t *this);
 ...
 */
DVDNAV_API dsi_t* dvdnav_get_current_nav_dsi(dvdnav_t *this);
 ...
 */
DVDNAV_API dvdnav_status_t dvdnav_get_title_string(dvdnav_t *this, const char **title_str);
 ...
 * title string.
 */
DVDNAV_API dvdnav_status_t dvdnav_get_serial_string(dvdnav_t *this, const char **serial_str);
 ...
 */
DVDNAV_API char * dvdnav_get_volid_string(dvdnav_t *this);
 ...
 */
DVDNAV_API dvdnav_status_t dvdnav_get_video_resolution(dvdnav_t *this, uint32_t *width, uint32_t *height);
 ...
 * (returns 0xffff if no such stream).
 */
DVDNAV_API uint16_t dvdnav_audio_stream_format(dvdnav_t *this, uint8_t stream);

/*
 * Returns number of channels in *logical* audio stream 'stream'
 * (returns 0xffff if no such stream).
 */
DVDNAV_API uint16_t dvdnav_audio_stream_channels(dvdnav_t *this, uint8_t stream);
 ...
 */
DVDNAV_API int8_t dvdnav_get_number_of_streams(dvdnav_t *this, dvdnav_stream_type_t stream_type);
 ...
 */
DVDNAV_API dvdnav_status_t dvdnav_toggle_spu_stream(dvdnav_t *this, uint8_t visibility);
 ...
 */
DVDNAV_API dvdnav_status_t dvdnav_set_active_stream(dvdnav_t *this, uint8_t stream_num,
 ...
 * the call fails.
 */
DVDNAV_API dvdnav_status_t dvdnav_angle_change(dvdnav_t *this, int32_t angle);

/*
 * Returns the current angle and number of angles present.
 */
DVDNAV_API dvdnav_status_t dvdnav_get_angle_info(dvdnav_t *this, int32_t *current_angle,
