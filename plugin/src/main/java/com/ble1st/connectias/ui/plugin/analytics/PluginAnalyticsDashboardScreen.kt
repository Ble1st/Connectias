                ...
                val bundle = AnalyticsExportBundle(
                    ...
                    pluginStats = stats.map {
                        AnalyticsPluginStat(
                            ...
                            enableCount = it.enableCount,
                            disableCount = it.disableCount
                        )
                    }
                )
        ...
        AlertDialog(
            ...
            text = {
                Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                    ...
                    Text("Session duration: ${s.sessionDurationMinutes} min")
                    Text("Session count: ${s.sessionCount}")
                    Spacer(Modifier.height(4.dp))
                    Text("Lifecycle", style = MaterialTheme.typography.titleSmall)
                    Text("Enabled: ${s.enableCount} times")
                    Text("Disabled: ${s.disableCount} times")
                }
            },
                    ...
                    items(stats) { s ->
                        Card(
                            ...
                            Column(modifier = Modifier.padding(14.dp), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                                ...
                                if (s.sessionDurationMinutes > 0 || s.sessionCount > 0) {
                                    Text("Usage: ${s.sessionDurationMinutes} min • ${s.sessionCount} sessions",
                                        style = MaterialTheme.typography.bodySmall,
