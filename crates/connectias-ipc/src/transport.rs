...
impl std::fmt::Display for ValidationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ValidationError::InvalidMessageId(id) => {
                write!(f, "Invalid message_id format: '{}'. message_id must be a valid UUID (e.g., generated by Uuid::new_v4()). Expected format: xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", id)
            },
