  ...
  group('NetworkSecurityService - SPKI Hash Extraction', () {
    ...
    group('SPKI Hash Extraction - Valid Certificates', () {
      test('should extract SPKI from valid X.509 certificate and compute hash', () async {
        ...
        service.registerPolicy(NetworkSecurityPolicy(
      ...
      test('should compute consistent SPKI hash for same certificate', () async {
        ...
        expect(hash1, equals(hash2), reason: 'Same certificate should produce same SPKI hash');
      });
    });
    ...
    group('Certificate Pinning Integration', () {
      test('should validate certificate pin when SPKI extraction succeeds', () async {
