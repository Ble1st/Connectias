...
interface IFileSystemBridge {
     ...
     */
    ParcelFileDescriptor createFile(String pluginId, String path, int mode);
     ...
     */
    ParcelFileDescriptor openFile(String pluginId, String path, int mode);
     ...
     */
    boolean deleteFile(String pluginId, String path);
     ...
     */
    boolean fileExists(String pluginId, String path);
     ...
     */
    String[] listFiles(String pluginId, String path);
     ...
     */
    long getFileSize(String pluginId, String path);
}
