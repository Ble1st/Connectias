...
fun ThemedButton(
    ...
    val colors = if (themeStyle is ThemeStyle.AdeptusMechanicus) {
        AdeptusMechanicusColors
    } else {
        StandardColors
    }
    ...
    Button(
        ...
        Text(
            text = getThemedString(text, themeStyle),
            style = if (themeStyle is ThemeStyle.AdeptusMechanicus) {
                AdeptusMechanicusTypography.button
            } else {
                StandardTypography.button
            }
        )
    }
}
