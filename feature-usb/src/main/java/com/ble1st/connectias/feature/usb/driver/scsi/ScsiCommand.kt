...
object ScsiCommand {
    ...
    // SCSI Sense Keys
    const val SENSE_KEY_NO_SENSE: Byte = 0x00
    const val SENSE_KEY_RECOVERED_ERROR: Byte = 0x01
    const val SENSE_KEY_NOT_READY: Byte = 0x02
    const val SENSE_KEY_MEDIUM_ERROR: Byte = 0x03
    const val SENSE_KEY_HARDWARE_ERROR: Byte = 0x04
    const val SENSE_KEY_ILLEGAL_REQUEST: Byte = 0x05
    const val SENSE_KEY_UNIT_ATTENTION: Byte = 0x06
    const val SENSE_KEY_DATA_PROTECT: Byte = 0x07
    const val SENSE_KEY_BLANK_CHECK: Byte = 0x08
    const val SENSE_KEY_ABORTED_COMMAND: Byte = 0x0B
    
    // Common ASC/ASCQ values
    const val ASC_NO_MEDIUM: Byte = 0x3A  // No medium present
    const val ASC_NOT_READY: Byte = 0x04  // Not ready, cause not reportable
