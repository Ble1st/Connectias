...
class AndroidSecurityService {
  ...
  Future<SecurityCheckResult> performCheck() async {
    try {
      ...
      if (result == null) {
        throw Exception(
          'Security check failed: received null result from platform',
        );
      }
      if (result is! Map) {
        throw Exception(
          'Security check failed: expected Map result, got ${result.runtimeType}',
        );
      }
      ...
      throw Exception(
        'Security check failed: invalid data format - ${e.message}',
      );
    }
  }
  ...
  Future<bool> detectRoot() async {
    try {
      ...
      if (result == null) {
        throw Exception(
          'Root detection failed: received null result from platform',
        );
      }
      if (result is! bool) {
        throw Exception(
          'Root detection failed: expected bool result, got ${result.runtimeType}',
        );
      }
  ...
  Future<bool> detectDebugger() async {
    try {
      ...
      if (result == null) {
        throw Exception(
          'Debugger detection failed: received null result from platform',
        );
      }
      if (result is! bool) {
        throw Exception(
          'Debugger detection failed: expected bool result, got ${result.runtimeType}',
        );
      }
  ...
  Future<bool> detectEmulator() async {
    try {
      ...
      if (result == null) {
        throw Exception(
          'Emulator detection failed: received null result from platform',
        );
      }
      if (result is! bool) {
        throw Exception(
          'Emulator detection failed: expected bool result, got ${result.runtimeType}',
        );
      }
...
class SecurityCheckResult {
  ...
  factory SecurityCheckResult.fromMap(Map<dynamic, dynamic> map) {
    ...
    if (map['passed'] == null) {
      throw ArgumentError(
        'SecurityCheckResult.fromMap: missing required field "passed"',
      );
    }
    if (map['passed'] is! bool) {
      throw ArgumentError(
        'SecurityCheckResult.fromMap: field "passed" must be a bool, got ${map['passed'].runtimeType}',
      );
    }
    ...
    if (map['details'] == null) {
      throw ArgumentError(
        'SecurityCheckResult.fromMap: missing required field "details"',
      );
    }
    if (map['details'] is! Map) {
      throw ArgumentError(
        'SecurityCheckResult.fromMap: field "details" must be a Map, got ${map['details'].runtimeType}',
      );
    }
    ...
    for (final entry in detailsMap.entries) {
      ...
      if (key is! String) {
        throw ArgumentError(
          'SecurityCheckResult.fromMap: details key must be a String, got ${key.runtimeType}',
        );
      }
      if (value is! bool) {
        throw ArgumentError(
          'SecurityCheckResult.fromMap: details value must be a bool, got ${value.runtimeType}',
        );
      }
