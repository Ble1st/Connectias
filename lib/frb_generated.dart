...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -2043930265;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
        stem: 'connectias_rust',
...
abstract class RustLibApi extends BaseApi {
  String crateApiGetLogLevel();

  List<String> crateApiGetLogs({
    String? levelFilter,
    required int limit,
    required int offset,
  });

  String crateApiInitApp();

  String crateApiInitDatabase({required String databasePath});

  String crateApiLogMessage({
    required String level,
    required String message,
    String? module,
  });

  String crateApiSetLogLevel({required String level});
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiGetLogLevelConstMeta =>
      const TaskConstMeta(debugName: "get_log_level", argNames: []);
  ...
  List<String> crateApiGetLogs({
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_opt_String(levelFilter, serializer);
        ...
        argValues: [levelFilter, limit, offset],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiGetLogsConstMeta => const TaskConstMeta(
    debugName: "get_logs",
    argNames: ["levelFilter", "limit", "offset"],
  );
  ...
  String crateApiLogMessage({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiLogMessageConstMeta,
  ...
  TaskConstMeta get kCrateApiLogMessageConstMeta => const TaskConstMeta(
